...
module CoordinatorAssignment
  module Modal
    ...
    # - This component can be rendered within a parent component like `CoordinatorListComponent`.
    #
    # ### Example:
    # ```ruby
    # <%= render CoordinatorAssignment::Modal::CoordinatorListItemComponent.new(coordinator, is_checked: true) %>
    # ```
    #
    # ### Parameters:
    ...
    #
    # ### Additional Details:
    # - `id`: The checkbox's ID is dynamically generated based on the coordinator's ID to ensure unique accessibility.
    ...
    class CoordinatorListItemComponent < ApplicationComponent
