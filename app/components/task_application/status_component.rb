...
class TaskApplication::StatusComponent < ApplicationComponent
  RECEIVED_ICON = <<-HTML
  ...
  ICON_MAPPINGS = {
    received: RECEIVED_ICON,
    under_review: UNDER_REVIEW_ICON,
    interviewing: INTERVIEWING_ICON,
    on_hold: ON_HOLD_ICON,
    accepted: ACCEPTED_ICON,
    rejected: REJECTED_ICON,
    withdrawn: WITHDRAWN_ICON
  }
